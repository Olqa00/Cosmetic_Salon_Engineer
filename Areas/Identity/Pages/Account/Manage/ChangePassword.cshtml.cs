...
namespace Engineer_MVC.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
			...
			var emailMessage = new Message(new string[] { user.Email }, _sharedResource["PasswordChangeConfirmation"], _sharedResource["YourPasswordChanged"]);
            _emailSender.SendEmail(emailMessage);

			await _signInManager.RefreshSignInAsync(user);
            _logger.LogInformation("User changed their password successfully.");
            StatusMessage = _sharedResource["YourPasswordChanged"];
